...
highYield:
  ...
  - Management is not only about picking a drug.
examFocus:
...
## First-pass clinical frame

Students should organize hypertension around:

- confirmation
- risk
- target-organ damage
- secondary causes
- lifestyle plus drug management

## Why this is a good prototype topic

It proves how the same wiki can grow from physiology into bedside medicine without rebuilding the architecture.
