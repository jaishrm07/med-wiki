...
highYield:
  ...
  - Many later physiology topics reuse this foundation.
examFocus:
...
This is one of those topics that looks basic but keeps coming back everywhere.

## What students should stop doing

Do not memorize transport types as vocabulary only. Always connect them to:
